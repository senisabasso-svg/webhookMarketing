...
export const api = {
  ...
  createCompanyScheduledPost: (payload) =>
    postScheduledForm("/company/instagram/scheduled-posts", payload),
  createAdminScheduledPost: (companyId, payload) =>
    postScheduledForm(
      `/admin/companies/${companyId}/instagram/scheduled-posts`,
      payload
    ),
